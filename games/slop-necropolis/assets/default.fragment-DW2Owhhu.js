import{t as e}from"./shaderStore-D-XQlhUT.js";import"./logDepthFragment-CTSVDsQV.js";import"./logDepthDeclaration--laj1kHT.js";import"./helperFunctions-Dh90YL4s.js";import"./fogFragment-CDrq7NOC.js";import"./clipPlaneFragment-BMMyRMGo.js";import"./clipPlaneFragmentDeclaration-CBiCX9i9.js";import"./oitFragment-CZRjMNC7.js";import"./mainUVVaryingDeclaration-OEjfMlyz.js";import"./defaultUboDeclaration-D5zNlbjM.js";var t=`defaultFragmentDeclaration`,n=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`lightsFragmentFunctions`,i=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`fresnelFunction`,o=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`defaultPixelShader`,c=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[s]||(e.ShadersStore[s]=c);var l={name:s,shader:c};export{l as defaultPixelShader};