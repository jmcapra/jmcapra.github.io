import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`depthOfFieldMergePixelShader`,n=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as depthOfFieldMergePixelShader};