...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`prePassDeclaration`,i=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`oitDeclaration`,o=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`lightFragmentDeclaration`,c=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`lightUboDeclaration`,u=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`shadowsFragmentFunctions`,m=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`samplerFragmentDeclaration`,g=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`reflectionFunction`,v=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`bumpFragmentMainFunctions`,b=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`lightFragment`,A=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`oitFragment`,M=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);