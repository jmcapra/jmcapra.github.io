import{t as e}from"./shaderStore-D-XQlhUT.js";import"./logDepthFragment-CTSVDsQV.js";import"./logDepthDeclaration--laj1kHT.js";import"./helperFunctions-Dh90YL4s.js";import"./fogFragment-CDrq7NOC.js";import"./clipPlaneFragment-BMMyRMGo.js";import"./clipPlaneFragmentDeclaration-CBiCX9i9.js";import"./oitFragment-CZRjMNC7.js";import"./mainUVVaryingDeclaration-OEjfMlyz.js";import"./harmonicsFunctions-CS7g7UNA.js";var t=`pbrFragmentDeclaration`,ee=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=ee);var n=`pbrFragmentExtraDeclaration`,te=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=te);var r=`samplerFragmentAlternateDeclaration`,i=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`pbrFragmentSamplersDeclaration`,o=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`subSurfaceScatteringFunctions`,ne=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=ne);var c=`importanceSampling`,re=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=re);var l=`pbrHelperFunctions`,u=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`pbrDirectLightingSetupFunctions`,ie=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=ie);var f=`pbrDirectLightingFalloffFunctions`,ae=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=ae);var p=`pbrBRDFFunctions`,oe=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=oe);var m=`hdrFilteringFunctions`,h=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=h);var g=`pbrDirectLightingFunctions`,_=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);var v=`pbrIBLFunctions`,y=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);var b=`pbrBlockAlbedoOpacity`,x=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=x);var S=`pbrBlockReflectivity`,se=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=se);var C=`pbrBlockAmbientOcclusion`,ce=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=ce);var w=`pbrBlockAlphaFresnel`,le=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=le);var T=`pbrBlockAnisotropic`,ue=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=ue);var E=`pbrBlockReflection`,de=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=de);var D=`pbrBlockSheen`,fe=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=fe);var O=`pbrBlockClearcoat`,k=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=k);var A=`pbrBlockIridescence`,j=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);var M=`pbrBlockSubSurface`,N=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=N);var P=`pbrBlockNormalGeometric`,F=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=F);var I=`pbrBlockNormalFinal`,L=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var R=`pbrBlockLightmapInit`,z=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var B=`pbrBlockGeometryInfo`,V=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=V);var H=`pbrBlockReflectance0`,pe=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=pe);var U=`pbrBlockReflectance`,me=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=me);var W=`pbrBlockDirectLighting`,he=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=he);var G=`pbrBlockFinalLitComponents`,ge=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=ge);var K=`pbrBlockFinalUnlitComponents`,_e=`vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=_e);var q=`pbrBlockFinalColorComposition`,ve=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=ve);var J=`pbrBlockImageProcessing`,ye=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=ye);var Y=`pbrBlockPrePass`,X=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=X);var Z=`pbrDebug`,be=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=be);var Q=`pbrPixelShader`,$=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var xe={name:Q,shader:$};export{xe as pbrPixelShader};